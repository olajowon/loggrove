...
jQuery.extend( {
	...
	Deferred: function( func ) {
		var tuples = [
				...
				// ... .then handler, argument index, [final state]
							...
							var that = this,
								...
								mightThrow = function() {
									...
									// Handle all other returned values
										...
										// Only substitute handler pass on context
...
function cloneCopyEvent( src, dest ) {
	...
	// 1. Copy private data: events, handler, etc.
...
jQuery.parseHTML = function( data, context, keepScripts ) {
	...
	if ( !context ) {
		...
		// Stop scripts or inline event handler from being executed immediately
